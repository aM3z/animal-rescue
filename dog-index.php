...
?>
	...
	<main role="main" class="clear main-wrapper">
		...
		<section class="index">
			<header><h2><a href="./details/dogs/yorkshire-terrier.php">Frodo</a></h2></header>
			<article>
			<img src=".\images\dogs\yorkshire-terrier-06.jpg" />
				<p>
		...
		<section class="index">
			<header><h2><a href="./details/dogs/welsh-springer-spaniel.php">Samwise</a></h2></header>
			<article>
				<img src=".\images\dogs\springer-spaniel-tennis-balls4.jpg"/>
				<p>
		...
		<section class="index">
			<header><h2><a href="./details/dogs/nova-scotia-duck-tolling-retriever.php">Pippin</a></h2></header>
			<article>
				<img src=".\images\dogs\nstr.jpg"/>
				<p>
				Curabitur rhoncus tellus nunc, et finibus nunc consectetur eu. Donec vestibulum commodo libero, sit amet viverra nibh porta non. Suspendisse pellentesque at nisl sit amet blandit. Proin sagittis, nibh vitae porta accumsan, tortor felis malesuada ex, et faucibus arcu metus et leo. Morbi massa arcu, varius eget sapien et, vehicula posuere massa. Aenean lacinia urna lacus. Praesent ligula elit, fermentum id leo nec, pellentesque tempus sem.
		...
		<section class="index">
			<header><h2><a href="./details/dogs/rottweiller.php">Merry</a></h2></header>
			<article>
				<img src=".\images\dogs\Rottweiler_standing_facing_left.jpg"/>
				<p>
				Curabitur rhoncus tellus nunc, et finibus nunc consectetur eu. Donec vestibulum commodo libero, sit amet viverra nibh porta non. Suspendisse pellentesque at nisl sit amet blandit. Proin sagittis, nibh vitae porta accumsan, tortor felis malesuada ex, et faucibus arcu metus et leo. Morbi massa arcu, varius eget sapien et, vehicula posuere massa. Aenean lacinia urna lacus. Praesent ligula elit, fermentum id leo nec, pellentesque tempus sem.
				</p>
			</article>
